...
function (_React$Component) {
  ...
  function Modal() {
    ...
    _this.onShow = function () {
      var doc = ownerDocument(_assertThisInitialized(_assertThisInitialized(_this)));
    ...
    _this.enforceFocus = function () {
      ...
      var currentActiveElement = activeElement(ownerDocument(_assertThisInitialized(_assertThisInitialized(_this))));
